...
"
    ...
    "
        ...
        <div className="mt-[20px] flex flex-col gap-[10px]">
          ...
          <label className="flex items-center gap-[10px] text-[14px] md:text-[16px] text-[#747474]">
            <input
              type="checkbox"
              name="privacy"
              checked={form.privacy}
              onChange={handleChange}
              className="mt-[4px]  w-[18px] h-[18px] lg:w-[28px] lg
                h-[28px] border border-[#1B20220F] accent-[#1B2022]"
            />
