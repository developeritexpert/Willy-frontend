            ...
            <div className="relative w-full max-w-[1074px] bg-white text-[#1B2022] max-h-[90vh] ">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                >
                  ...
                  <p>
                    Descubre nuestras ofertas limitadas en Piedra Sinterizada.
                    La base perfecta para tu hogar, oficina o comercio te
                    espera{" "}
                  </p>
                ...
                <div className="lg:relative  md:pt-6 lg:pt-[37px]">
                  ...
                  <img
                    src="/img/pop/1.png"
                    alt="product"
                    className="mt-8 md:mt-0 lg:mt-8 max-w-[90%] lg:absolute mx-auto lg:right-0 lg:top-[146px] lg:max-w-none"
                  />
                </div>
              </div>
            </div>
