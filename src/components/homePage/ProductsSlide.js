...
export default function ProductsSlide() {
  ...
  return (
    <div data-aos="fade-down" className="ProductsSlide overflow-x-hidden max-w-[1920px] mx-auto px-[15px] md:px-8 lg:px-12  2xl:px-[240px] mb-[60px] md:mb-[90px]  2xl:mb-[191px]">
