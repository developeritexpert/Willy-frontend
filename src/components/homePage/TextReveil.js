...
export default function TextReveal() {
  ...
  return (
    <section className="content-animate mb-12 md:mb-20 lg:mb-32 2xl:mb-[170px]" ref={sectionRef}>
      <div className="max-w-[1920px] mx-auto px-5 md:px-12 lg:px-12 2xl:px-[184px]">
        <div className="animate leading-[1.3] md:leading-[1.4] lg:leading-[57px] flex justify-center flex-wrap font-medium text-center text-2xl md:text-3xl lg:text-[44px] mx-auto md:max-w-[500px] lg:max-w-[700px] 2xl:max-w-[920px]">
