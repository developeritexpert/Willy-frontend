...
export default function Header() {
  ...
  const isLightHeader = isCustomize;
  ...
  return (
    <motion.header
      ...
      className={`${isCustomize?"py-6 xl:py-8":"py-4"}  inset-x-0 z-50 ${
    ...
    >
      <div className="flex items-center justify-between max-w-[1920px] mx-auto px-[15px] md:px-8 lg:px-12 2xl:px-[60px] uppercase">
        <img
          src={isLightHeader ? "/img/logo-dark.svg" : "/img/logo.svg"}
          className="w-[120px] 2xl:max-w-[164px]"
        />
        ...
        <div className=" flex items-center gap-x-[33px]">
          ...
          <button className="cart relative ">
            <span
              className={`absolute w-[14px] h-[14px] inline-flex items-center justify-center rounded-full text-[8px]
    ${
      isLightHeader
